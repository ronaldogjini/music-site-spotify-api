...
function SongElement({ track }) {
    return (
        <div className="container w-80 mx-auto  bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transform hover:scale-105 duration-500">
            <img
                className="w-full"
                src={`${track.album.images[0] !== undefined ? track.album.images[0].url : 'https://t3.ftcdn.net/jpg/03/46/83/96/360_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg'}`}
                alt={track.name} />
